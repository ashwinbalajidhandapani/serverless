...
awssdk.config.update({ region: 'us-east-2' })
            ...
            if (Object.keys(emaillist).length === 0) {
                let emailInfoParams = {
                    ...
                    Message: {
                        Body: {
                            Text: {
                                Data: "Verify your email  https://prod.ashwinbalaji-dhandapani.xyz/v1/verifyUserEmail?email=" + emailId + "&token=" + tokenValue
                            }
                        },
                        Subject: {
                    ...
                    Source: "noreply@prod.ashwinbalaji-dhandapani.xyz"
                };
